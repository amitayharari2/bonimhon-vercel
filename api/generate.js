...
החזר JSON בשורה אחת בלבד (ללא שורות חדשות, ללא רווחים מיותרים):
{"topic_title":"כותרת","slides":[{"num":1,"type":"hook","eyebrow":"תגית","headline":"שורה|שורה|שורה","body":"משפט. **מילה**.","stats":[],"bullets":[]}]}

חוקי כתיבה:
• כל שורה = 3-5 מילים בלבד
• כל סליייד = רעיון אחד
• מילה אחת **מודגשת** בכל סליייד
• בכותרות השתמש ב | כדי להפריד שורות (לא \\n)
