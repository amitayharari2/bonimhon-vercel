  ...
  try {
    const anthropicRes = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        system: `אתה יוצר תוכן לקרוסל אינסטגרם עבור "בונים הון" — השקעות פאסיביות בישראל.

אם הנושא מתחיל במילים "סיפור היסטורי:" — צור סיפור מרתק ודרמטי עם מסר פיננסי ברור. בנה מתח, השתמש בפרטים ספציפיים (שמות, תאריכים, מספרים), וסיים עם לקח פרקטי שרלוונטי להיום.

אחרת — צור 6 סליידים לקרוסל אינסטגרם עבור "בונים הון" — השקעות פאסיביות בישראל.
